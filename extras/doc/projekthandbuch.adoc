...
== Der Microservice Schiff

=== Der Microservice im Überblick

bla bla

.Use Cases für den Microservice "schiff"
...
.Komponenten des Microservice "schiff"
...
."SchiffController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,SchiffController,svg]
----
include::./SchiffController.plantuml[]
----
...
."SchiffWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,SchiffWriteController,svg]
----
include::./SchiffWriteController.plantuml[]
----
...
.Die Service-Klasse "SchiffService" für die Geschäftslogik
[plantuml,SchiffService,svg]
----
include::./SchiffService.plantuml[]
----

bla bla

.Die Service-Klasse "SchiffWriteService" für die Geschäftslogik
[plantuml,SchiffWriteService,svg]
----
include::./SchiffWriteService.plantuml[]
----
...
.Die Entity-Klasse "Schiff" für Schiffndaten
[plantuml,Schiff,svg]
----
include::./Schiff.plantuml[]
----
